 ...
 * @author school
 */
public class SaveDiscardChanges extends javax.swing.JFrame {

    private MainFrame m;
    /**
     * Creates new form SaveDiscardChanges
     */
    public SaveDiscardChanges() {
        initComponents();
    }
    public SaveDiscardChanges(MainFrame m) {
        initComponents();
        this.m = m;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaveDiscardChanges.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SaveDiscardChanges().setVisible(true);
            }
        });
    }
